...
The longest recorded long jump in this data set was achieved by
**`r decathlon_analysis$long_jump_max$name`**,
with a distance of
**`r decathlon_analysis$long_jump_max$event_score`** m.

# Average 100 m sprint time
...
# Highest total points across competitions
...
We are considering the top three competitors (in each competition, not each event) only.
...
# Average points in 400 m sprint groups

The final bit of analysis is a bit more complicated. We want to compare the average points for competitors who ran the 400m in less than 50 seconds, against those than ran 400m in more than 50 seconds.
